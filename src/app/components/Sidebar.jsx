            ...
            <nav className="flex-1 space-y-1 overflow-y-auto">
              ...
              <div>
                ...
                >
                  ...
                  <ChevronDown
                    size={16}
                    className={`transition-transform ${openSubmenus.dashboard ? "rotate-180" : ""}`}
                  />
                </button>
              ...
              <div>
                ...
                >
                  ...
                  <ChevronDown
                    size={16}
                    className={`transition-transform ${openSubmenus.apps ? "rotate-180" : ""}`}
                  />
                </button>
                {openSubmenus.apps && (
                  <div className="ml-6 space-y-1 mt-1 border-l border-gray-700 pl-2 py-1">
              ...
              <div>
                ...
                >
                  ...
                  <ChevronDown
                    size={16}
                    className={`transition-transform ${openSubmenus.pages ? "rotate-180" : ""}`}
                  />
                </button>
                {openSubmenus.pages && (
                  <div className="ml-6 space-y-1 mt-1 border-l border-gray-700 pl-2 py-1">
              ...
              <div>
                ...
                >
                  ...
                  <ChevronDown
                    size={16}
                    className={`transition-transform ${openSubmenus.authentication ? "rotate-180" : ""}`}
                  />
                </button>
              ...
              <div>
                ...
                >
                  ...
                  <ChevronDown
                    size={16}
                    className={`transition-transform ${openSubmenus.components ? "rotate-180" : ""}`}
                  />
                </button>
              ...
              <div>
                ...
                >
                  ...
                  <ChevronDown
                    size={16}
                    className={`transition-transform ${openSubmenus.charts ? "rotate-180" : ""}`}
                  />
                </button>
                {openSubmenus.charts && (
                  <div className="ml-6 space-y-1 mt-1 border-l border-gray-700 pl-2 py-1">
              ...
              <div>
                ...
                >
                  ...
                  <ChevronDown
                    size={16}
                    className={`transition-transform ${openSubmenus.forms ? "rotate-180" : ""}`}
                  />
                </button>
                {openSubmenus.forms && (
                  <div className="ml-6 space-y-1 mt-1 border-l border-gray-700 pl-2 py-1">
