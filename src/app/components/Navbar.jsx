  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex items-center gap-2 relative">
          ...
          <div className="relative">
            ...
            {activeDropdown === "lang" && (
              <div className={`absolute right-0 mt-2 w-40 rounded-lg shadow-lg overflow-hidden py-1 animate-fadeIn ${
                darkMode 
                  ? "bg-[#1e293b] text-gray-200 border border-gray-700" 
                  : "bg-white text-gray-800 border border-gray-200"
              }`}>
                <button className={`flex items-center gap-2 px-4 py-2 w-full text-left transition-colors ${
          ...
          <div className="relative">
            ...
            {activeDropdown === "cart" && (
              <div className={`absolute right-0 mt-2 w-80 rounded-lg shadow-lg overflow-hidden animate-fadeIn ${
                darkMode 
                  ? "bg-[#1e293b] text-gray-200 border border-gray-700" 
                  : "bg-white text-gray-800 border border-gray-200"
              }`}>
                ...
                <div className="max-h-60 overflow-y-auto">
                  <div className={`p-3 border-b transition-colors ${
                    ...
                    <p className={`text-xs mt-1 ${
                      darkMode ? "text-gray-400" : "text-gray-500"
                    }`}>Customer #3245 placed a new order</p>
                  ...
                  <div className={`p-3 border-b transition-colors ${
                    ...
                    <p className={`text-xs mt-1 ${
                      darkMode ? "text-gray-400" : "text-gray-500"
                    }`}>Server maintenance completed successfully</p>
                    <p className={`text-xs mt-2 ${
                      darkMode ? "text-gray-500" : "text-gray-400"
                    }`}>45 minutes ago</p>
                  </div>
                  <div className={`p-3 border-b transition-colors ${
                    ...
                    <p className={`text-xs mt-1 ${
                      darkMode ? "text-gray-400" : "text-gray-500"
                    }`}>New payment of $299.99 received</p>
                    <p className={`text-xs mt-2 ${
                      darkMode ? "text-gray-500" : "text-gray-400"
                    }`}>1 hour ago</p>
                  </div>
          ...
          <div className="relative">
            ...
            {activeDropdown === "apps" && (
              <div className={`absolute right-0 mt-2 w-48 rounded-lg shadow-lg grid grid-cols-2 gap-1 p-2 animate-fadeIn ${
                darkMode 
                  ? "bg-[#1e293b] text-gray-200 border border-gray-700" 
                  : "bg-white text-gray-800 border border-gray-200"
              }`}>
                <button className={`flex flex-col items-center justify-center p-3 rounded-md transition-colors ${
                  darkMode ? "hover:bg-gray-800" : "hover:bg-gray-100"
                }`}>
          ...
          <div className="relative">
            ...
            {activeDropdown === "profile" && (
              <div className={`absolute right-0 mt-2 w-56 rounded-lg shadow-lg overflow-hidden py-1 animate-fadeIn ${
                darkMode 
                  ? "bg-[#1e293b] text-gray-200 border border-gray-700" 
                  : "bg-white text-gray-800 border border-gray-200"
              }`}>
                ...
                <button className={`flex items-center gap-2 px-4 py-2 w-full text-left transition-colors text-red-400 ${
                  darkMode ? "hover:bg-gray-800" : "hover:bg-gray-100"
                }`}>
                  <LogOut size={16} />
                  Logout
      ...
      <div className={`fixed inset-0 z-50 transition-opacity duration-300 ${isSettingsOpen ? "opacity-100" : "opacity-0 pointer-events-none"}`}>
        ...
        <aside className={`absolute right-0 top-0 h-full w-80 shadow-lg transform transition-transform duration-300 ${
          ...
          <div className={`flex items-center justify-between p-4 border-b ${
            ...
            <button onClick={toggleSettings} className={`p-1 rounded ${
              darkMode ? "hover:bg-gray-800" : "hover:bg-gray-200"
            }`}>
              <X size={20} />
            </button>
          ...
          <div className="p-4 space-y-6 overflow-y-auto h-full pb-20">
            ...
            <div>
              ...
              <div className="space-y-2">
                <button className={`flex items-center gap-2 w-full p-3 rounded-lg transition-colors text-left ${
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className={`p-3 rounded-lg ${
                  ...
                  <select className={`w-full rounded-md p-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                    darkMode 
      ...
      <style jsx>{`
        ...
        .fi-gb { background-image: url('data:image/svg+xml;base64,'); }
        .fi-id { background-image: url('data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCA2MCAzMCI+PHJlY3Qgd2lkdGg9IjYwIiBoZWlnaHQ9IjMwIiBmaWxsPSIjZmYiLz48cmVjdCB3aWR0aD0iNjAiIGhlaWdodD0iMTUiIGZpbGw9IiNjNjAwMDAiLz48L3N2Zz4='); }
