...
// Komponen Bar Chart utama yang telah ditingkatkan
const BarChart = ({
  data,
  options,
  title,
    ...
    datasets: [
      {
        ...
        borderRadius: 6,
        hoverBackgroundColor: "rgba(59, 130, 246, 1)",
        hidden: !datasetsVisible.stacked,
      },
      {
        label: "Product B",
        data: [28, 48, 40, 19, 86, 27, 90],
  ...
  const filteredCharts = [
    {
      ...
      description: "A simple bar chart showing sales data across months.",
      code: `const data = {
  labels: ['January', 'February', 'March', 'April', 'May', 'June', 'July'],
  datasets: [
    {
...
<BarChart 
  data={data} 
  title="Monthly Sales" 
  description="Sales data from January to July"
/>`,
      content: (
        <BarChart
          data={basicChartData}
    ...
    },
    {
      ...
      description: "Bar chart comparing multiple products across months.",
      code: `const data = {
  labels: ['January', 'February', 'March', 'April', 'May', 'June', 'July'],
  datasets: [
    {
...
/>`,
    ...
    },
    {
      ...
      description: "A horizontal bar chart showing revenue data.",
      code: `const data = {
  labels: ['January', 'February', 'March', 'April', 'May', 'June', 'July'],
  datasets: [
    {
...
<BarChart 
  ...
  description="Revenue data from January to July"
/>`,
      content: (
        <BarChart
          data={horizontalChartData}
          options={{ indexAxis: isHorizontalView ? "y" : "x" }}
          title="Monthly Revenue"
          description="Revenue data from January to July"
          onRefresh={handleRefreshChart}
          isRefreshing={isRefreshing}
    ...
    },
    {
      ...
      description:
        "A stacked bar chart showing multiple product contributions.",
      code: `const data = {
  labels: ['January', 'February', 'March', 'April', 'May', 'June', 'July'],
  datasets: [
    {
...
<BarChart 
  ...
  description="Monthly sales data stacked by product"
/>`,
      content: (
        <BarChart
        ...
        <main className="flex-1 relative z-10 py-8">
          <div className="max-w-7xl mx-auto px-6">
            ...
            >
              ...
              >
                Beautiful, responsive bar chart components with light and dark
                mode support
              </p>
            </motion.div>
                ...
                filteredCharts.map((chart, index) => (
                  ...
                  >
                    <ChartExample
                      ...
                      darkMode={darkMode}
                      onToggleDataset={
                        chart.id === "multi-dataset" || chart.id === "stacked"
            ...
            >
              ...
              >
                ...
                <div className="relative my-4">
                  ...
                  >
                    <pre className="text-sm font-mono">{`import { Bar } from 'react-chartjs-2';
import {
  Chart as ChartJS,
  CategoryScale,
  LinearScale,
                  ...
                  <table className="w-full">
                    ...
                    <tbody className={darkMode ? "text-white" : "text-black"}>
                      ...
                      <tr>
                        ...
                        <td className="px-4 py-3 text-sm">Function</td>
                        <td className="px-4 py-3 text-sm">
                          Callback function to toggle between
                      ...
                      <tr className={darkMode ? "bg-gray-800" : "bg-gray-50"}>
                        ...
                        <td className="px-4 py-3 text-sm">Boolean</td>
                        <td className="px-4 py-3 text-sm">
                          Whether the chart is in horizontal mode
                        </td>
                      </tr>
                      <tr>
                        <td className="px-4 py-3 font-mono text-sm">
